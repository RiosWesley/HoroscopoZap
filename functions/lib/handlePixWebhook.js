...
exports.handlePixWebhook = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const crypto_1 = __importDefault(require("crypto")); // Para validação da assinatura
...
const validateWebhookSignature = (req, secret) => {
    ...
    try {
        ...
        if (trusted.length === calculated.length && crypto_1.default.timingSafeEqual(trusted, calculated)) {
...
//# sourceMappingURL=handlePixWebhook.js.map